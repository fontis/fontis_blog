...
class Fontis_Blog_Block_Manage_Cat_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry("blog_data") && Mage::registry("blog_data")->getId()) {
            return Mage::helper("blog")->__("Edit Category  '%s'", $this->escapeHtml(Mage::registry("blog_data")->getTitle()));
        } else {
